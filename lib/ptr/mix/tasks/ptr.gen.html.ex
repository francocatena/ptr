defmodule Mix.Tasks.Ptr.Gen.Html do
  @shortdoc "Generates controller, views, and context for an HTML resource"

  @moduledoc """
  Generates controller, views, and context for an HTML resource.

      mix ptr.gen.html Accounts User users name:string age:integer
  ...
  Alternatively, the `--context-app` option may be supplied to the generator:
      ...
      mix ptr.gen.html Sales User users --context-app warehouse
  ...
  a `--table` option may be provided. For example:
      ...
      mix ptr.gen.html Accounts User users --table cms_users
  ...
  def run(args) do
    if Mix.Project.umbrella?() do
      Mix.raise("mix ptr.gen.html can only be run inside an application directory")
    end
  ...
  def files_to_be_generated(%Context{schema: schema, context_app: context_app}) do
    ...
    [
      ...
      {:eex, "_form.html.eex",
       Path.join([web_prefix, "templates", web_path, schema.singular, "_form.html.eex"])},
      {:eex, "index.html.eex",
       Path.join([web_prefix, "templates", web_path, schema.singular, "index.html.eex"])},
      {:eex, "empty.html.eex",
       Path.join([web_prefix, "templates", web_path, schema.singular, "empty.html.eex"])},
      {:eex, "new.html.eex",
  ...
  def copy_new_files(%Context{} = context, paths, binding) do
    ...
    Mix.Phoenix.copy_from(paths, "priv/templates/ptr.gen.html", binding, files)
