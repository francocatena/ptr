defmodule Mix.Tasks.Ptr.Gen.Schema do
  @shortdoc "Generates an Ecto schema and migration file"

  @moduledoc """
  Generates an Ecto schema and migration.

      mix ptr.gen.schema Blog.Post blog_posts title:string views:integer
  ...
  the type makes it default to `:string`:
      ...
      mix ptr.gen.schema Blog.Post blog_posts title views:integer
  ...
  referenced table:
      ...
      mix ptr.gen.schema Blog.Post blog_posts title user_id:references:users
  ...
  type of the underlying array element to be given too:
      ...
      mix ptr.gen.schema Blog.Post blog_posts tags:array:string

  Unique columns can be automatically generated by using:

      mix ptr.gen.schema Blog.Post blog_posts title:unique unique_int:integer:unique
  ...
  a `--table` option may be provided. For example:
      ...
      mix ptr.gen.schema Blog.Post posts --table cms_posts
