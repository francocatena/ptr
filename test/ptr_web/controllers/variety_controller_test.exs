defmodule PtrWeb.VarietyControllerTest do
  ...
  describe "unauthorized access" do
    test "requires user authentication on all actions", %{conn: conn} do
      Enum.each(
        [
          get(conn, Routes.variety_path(conn, :index)),
          get(conn, Routes.variety_path(conn, :new)),
          post(conn, Routes.variety_path(conn, :create, %{})),
          get(conn, Routes.variety_path(conn, :show, "123")),
          get(conn, Routes.variety_path(conn, :edit, "123")),
          put(conn, Routes.variety_path(conn, :update, "123", %{})),
          delete(conn, Routes.variety_path(conn, :delete, "123"))
        ],
        fn conn ->
  ...
  describe "index" do
    ...
    test "lists all varieties", %{conn: conn, variety: variety} do
      conn = get(conn, Routes.variety_path(conn, :index))
  ...
  describe "new variety" do
    ...
    test "renders form", %{conn: conn} do
      conn = get(conn, Routes.variety_path(conn, :new))
  ...
  describe "create variety" do
    ...
    test "redirects to show when data is valid", %{conn: conn} do
      conn = post(conn, Routes.variety_path(conn, :create), variety: @create_attrs)

      assert %{id: id} = redirected_params(conn)
      assert redirected_to(conn) == Routes.variety_path(conn, :show, id)
    end

    @tag login_as: "test@user.com"
    test "renders errors when data is invalid", %{conn: conn} do
      conn = post(conn, Routes.variety_path(conn, :create), variety: @invalid_attrs)
  ...
  describe "edit variety" do
    ...
    test "renders form for editing chosen variety", %{conn: conn, variety: variety} do
      conn = get(conn, Routes.variety_path(conn, :edit, variety))
  ...
  describe "update variety" do
    ...
    test "redirects when data is valid", %{conn: conn, variety: variety} do
      conn = put(conn, Routes.variety_path(conn, :update, variety), variety: @update_attrs)

      assert redirected_to(conn) == Routes.variety_path(conn, :show, variety)
    end

    @tag login_as: "test@user.com"
    test "renders errors when data is invalid", %{conn: conn, variety: variety} do
      conn = put(conn, Routes.variety_path(conn, :update, variety), variety: @invalid_attrs)
  ...
  describe "delete variety" do
    ...
    test "deletes chosen variety", %{conn: conn, variety: variety} do
      conn = delete(conn, Routes.variety_path(conn, :delete, variety))

      assert redirected_to(conn) == Routes.variety_path(conn, :index)
    end
  end
